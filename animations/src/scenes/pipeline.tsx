    ...
    <>
      ...
      <Node position={[view.size().x / 4, 0]} >
        ...
        <Rect ref={containerRight} position={[0,0]} opacity={1} 
          ...
          <MyTxtRect text="HCC site"         ref={tr.hcc} y={yPos(-2, 2)} />
          <MyTxtRect text="QuartoPub"        ref={tr.quarto} y={yPos(-1, 2)} />
          <MyTxtRect text="Scheduled Action" ref={tr.gha} y={yPos(0, 2)} />
          <MyTxtRect text="Version Control"  ref={tr.gh} y={yPos(1, 2)} />
          <MyTxtRect text="IDE"              ref={tr.ide} y={yPos(2, 2)} />
